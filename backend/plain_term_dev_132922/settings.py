"""
Django settings for plain_term_dev_132922 project.
...
ROOT_URLCONF = 'plain_term_dev_132922.urls'
...
WSGI_APPLICATION = 'plain_term_dev_132922.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_term_dev_132922 API",
    "DESCRIPTION": "API documentation for plain_term_dev_132922 App",
    "VERSION": "v1",
}
